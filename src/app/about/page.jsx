      ...
      <div className={styles.textImageContainer}>
        <div className={styles.textContainer}>
          ...
          <p className={styles.desc}>
            Bienvenue sur BlaNian.Event, votre destination virtuelle pour
            l&apos;innovation, l&apos;inspiration et la connexion.
            <br />
            ...
            l&apos;innovation,BlaNian.Event est l&apos;endroit où vous trouverez
